...
class MachineMotion(object):
    ...
    # Class constructor
    def __init__(self, machineIp=DEFAULT_IP_ADDRESS.ethernet, gCodeCallback=(lambda *args: None), machineMotionHwVersion=MACHINEMOTION_HW_VERSIONS.MMv1) :
        '''
